...
and click-to-drill country panel. \href{https://global-trade-viz.onrender.com}{\textbf{global-trade-viz.onrender.com}}
\end{center}
...
We did not produce hand-drawn sketches at M1; our equivalent was a
\textbf{screenshot-driven design process} where we shipped a rough first
iteration of each view and refined it from real screenshots. The grid below
shows the final state of the seven core views.
...
\href{https://global-trade-viz.onrender.com}{global-trade-viz.onrender.com}
...
Live dashboard: \href{https://global-trade-viz.onrender.com}{global-trade-viz.onrender.com}.
